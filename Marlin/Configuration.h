...
#define STRING_CONFIG_H_AUTHOR "(Chris Thompson for Cube)" // Who made the changes.
...
#define MACHINE_UUID "5e2c5850-9c0b-11e7-abc4-cec278b6b50a"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Tuned OmniaDropV3
  //Calibrated @200C 1/6/24
  //M303 S200 C10
	#define  DEFAULT_Kp 12.13
	#define  DEFAULT_Ki 1.37
	#define  DEFAULT_Kd 26.82
//M301 H1 P12.13 I1.37 D26.82
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {87.49,87.49,1066.67,480}  // tuned to OmniaDrop
...
/**
installed on MX1 servo header on RAMBo v1.1
from pins.rambo #define SERVO0_PIN         22 // Motor header MX1
-Chris Thompson
*/
...
//updated with OmniaDrop v3 extruder location
...
#define Y_MAX_POS 290 //was Y_BED_SIZE
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_INVERTING false // set to true in old config. set to true to invert the logic of the sensor.
  #define ENDSTOPPULLUP_FIL_RUNOUT // Uncomment to use internal pullup for filament runout pins if the sensor is defined.
  #define FILAMENT_RUNOUT_SCRIPT "G1 X230 Y295 E-3 F3000\nM0" //gcode for filament chnage  \n is new line
#endif
...
//calibrated for OmniaDrop v3
  #define LEFT_PROBE_BED_POSITION 33.5
  #define RIGHT_PROBE_BED_POSITION 258.00
  #define FRONT_PROBE_BED_POSITION 30.5
  #define BACK_PROBE_BED_POSITION 249.00
