...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
 ...
 // #define AUTO_BED_LEVELING_GRID
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -3.7  // Z probe to nozzle Z offset: -below (always!)
...
//  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with Z probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT 104    // X point for Z homing when homing all axis (G28).
    #define Z_SAFE_HOMING_Y_POINT 135    // Y point for Z homing when homing all axis (G28).
